...
Qdot_ext_w_storage = HeatFlux_ext_wall_storage(T_ext,P_ext,T_wall_storage,opts);
Qdot_w_t_storage = HeatFlux_wall_storage(P_storage,x_storage,T_wall_storage,T_storage);%Thermal heat flux from the wall to the tank

Qdot_ext_w_tank = HeatFlux_ext_wall_tank(T_ext,P_ext,T_wall_tank,opts);
Qdot_w_t_tank = HeatFlux_wall_tank(P_tank,x_tank,T_wall_tank,T_tank);%Thermal heat flux from the wall to the tank
