...
%% INPUTS
% Geometry
Dstar = 0.0384;                                                                  % Diameter of nozzle at throat [length]
radius = Dstar/2;                                                                 % Radius of throat [length]
...
Ae_At_Set = 4.75;%1.74825;              %Change value here                              % Nozzle area ratio []
...
P0 = 26e5;                                                                  % Combustion pressure [Pa]
T0 = 3650;                                                                  % Combustion temperature [K]
...
% for i=1:1:L-1
% res(i)=Expansion{i,i+1}.M;
% res1(i)=Expansion{i,i+1}.X;
% end
% plot(res1,res)